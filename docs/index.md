...
![Screenshot of Jupyter Fancyprofile](images/screen-mock.png)
...
:::{card} 🔗 Permalinks
Generate shareable URLs that can launch servers with pre-configured options, perfect for workshops, courses, or shared environments.
:::
